!function(e, t) {
    ...
    return (() => {
        ...
        var e = {
            d: (t, r) => {
                for (var s in r) 
                    e.o(r, s) && !e.o(t, s) && Object.defineProperty(t, s, { enumerable: !0, get: r[s] });
            },
        ...
        class r {
            ...
            _randomText(e) {
                let t = "";
                for (let r = 0; r < e; r += 1) 
                    t += this.characters[Math.floor(Math.random() * this.characters.length)];
                ...
                if (0 === this.frameIndex) {
                    ...
                    for (let e = 0; e < this.encodingCounters.length; e += 1) {
                        if (0 !== this.encodingCounters[e]) {
                            ...
                            t[e] = this._randomText(1);
                            this.scrambledText = t.join("");
                        }
                    }
                }
                ...
                if (this.scrambledText === this.targetText) {
                    ...
                    if (0 === this.frameIndex) {
                        ...
                        for (let t = 0; t < this.decodingCounters.length; t += 1) {
                            if (0 !== this.decodingCounters[t]) {
                                e += this.characters[Math.floor(Math.random() * this.characters.length)];
